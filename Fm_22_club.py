...
df_new.drop(["Unnamed: 0",'Link',"Release_Clause","CName","CLink","Name","CStatus",'Unique_ID'], axis=1,inplace=True)
...
# Filtreleme
df_new = df_new.loc[df_new["Wages"] < 41497.5]
df_new.shape
...
#########################################
y = final_df["Wages"]
X = final_df.drop(["Wages","Img_Link"],axis=1)
